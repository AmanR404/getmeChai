  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        <div className="flex items-center mb-6">
            <img className="w-20 h-20 rounded-full mr-4" width={20} height={20} src="/group.gif" alt="Fans Want to Collaborate" />
            <div>
        ...
        <div className="flex items-center mb-6">
            <img className="w-20 h-20 rounded-full mr-4" width={20} height={20} src="/coin.gif" alt="Support Through Chai" />
            <div>
