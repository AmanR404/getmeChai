  ...
  return (
    ...
    <ToastContainer
        ...
        <div className='text-gray-900 flex flex-col gap-2 justify-center items-center'>
            <button className='bg-white w-60 flex justify-center gap-2 items-center rounded-md py-1 hover:bg-gray-300'><img width={25} src="https://encrypted-tbn0.gstatic.com/imgs?q=tbn:ANd9GcT5Nhdac4WogJcyclKl4W0SNeUBj7q-hBCAWg&s" alt="" /><span>Continue with Google</span></button>
            <button className='bg-white w-60 flex justify-center gap-1 items-center rounded-md py-1 hover:bg-gray-300'><img width={25} src="https://encrypted-tbn0.gstatic.com/imgs?q=tbn:ANd9GcRXu0p5xl_tB4Id8caYETptjtbTevOIU1vXOA&s" alt="" /><span>Continue with LinkedIn</span></button>
            ...
            <button className='bg-white w-60 flex justify-center gap-1 items-center rounded-md py-1 hover:bg-gray-300'><img width={25} src="https://encrypted-tbn0.gstatic.com/imgs?q=tbn:ANd9GcTtfbcYeYgf0wQJ-LSPm3CPbyB7T1p0f5bnaA&s" alt="" /><span>Continue with Facebook</span></button>
